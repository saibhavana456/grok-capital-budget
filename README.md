...
SELECT PF_NO, ROLE_CODE, IS_ACTIVE FROM APP_USER;      -- 600110 MAKER, 600221 CHECKER (Admin = AdminApp config)
SELECT EMPLID, NAME, EMP_SCALE_CODE FROM STAFF_DETAILS; -- after SEED_STAFF_DETAILS_MAKER_CHECKER.sql
